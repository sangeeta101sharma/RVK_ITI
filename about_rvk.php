...
<body id="bg">
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(pictures/2.jpg);">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12" style="min-height: 150px;">
                                <div class="col-lg-6 col-sm-6" style="float:right;">
                                    <h1>Welcome To RVK Industrial Training Institute</h1>
                                    <p>Domestic & global opportunities in various fields like industries and service sectors are getting increased day by day. These sectors have large employment potential that can be grabbed by skilled & multi-skilled youngsters. Our department is providing two trades Fitter & Electrician .
The governing body of the college has a vast experience in academics and corporate world for its excellent governance. The institute is endeavoring to develop and extra ordinary class of professional with leadership quality which is most suited to the corporate world with excellent attitude.
<br>
The Institute is engaged in imparting training in the scheme of NCVT, and courses as per specific requirement of the local industries. The academy pursues the ideals of training of minds and quest for knowledge and of healthy life.<br>
The institute has been setup with the objective of imparting craftsman training to aspiring technicians offering an environment where young minds can grow to their full potential and become skilled and disciplined Technicians. The institutes is striving for reducing unemployment among educated youth as well by equipping them with suitable skills for industrial employment and satisfy the requirements of todays hi-tech manufacturing and service industrial sectors..</p>
                                </div>
                                <div class="col-lg-6 col-sm-6" >
                                    <img src="pictures/18.jpg" alt="images" style="width:800px;height:440px;margin-top:80px;">
                                </div>
