...
<body id="bg">
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(pictures/director.jpg);
            background-size:cover;background-position: center;background-repeat: no-repeat;">
                ...
                <div class="container">
                    ...
                    <div class="dez-bnr-inr-entry">
                        ...
                        <h1 class="text-white">About RVK ITI</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12" style="min-height: 150px;">
                                <div class="col-lg-6 col-sm-6" style="float:right;">
                                    <h1 style="color:brown;border-bottom:2px solid black;text-align:center;padding-bottom:5px;">Director Message</h1>
                                    <p><b><i>RVK Industrial Training Institute is in the 15th year of its existence, contributing to technical education in Fitter and Electrician trade. Institution aims at the complete development of the students and our faculty members, to provide the training and every possible support in all theirendeavors and academics.</i></b></p>
                                    <br>
                                    <p><i class="fa fa-circle" aria-hidden="true" style="color:darkred;"></i>&nbsp;Our campus is set in a beautiful landscape with a spectacular view of Naini, Allahabad � an environment for industrial growth and people interaction. </p>
                                    <p><i class="fa fa-circle" aria-hidden="true" style="color:darkred;"></i>&nbsp;We would like to welcome you to join RVK family and be a part of change in education system and social development.</p>
                                    <p><i class="fa fa-circle" aria-hidden="true" style="color:darkred;"></i>&nbsp;Thank you for choosing us for you child to provide a rapid startup career in technical platform.</p>
                                    <p><i class="fa fa-circle" aria-hidden="true" style="color:darkred;"></i>&nbsp;Our faculty is highly qualified and well trained to provide the technical education and support the overall growth to our students.</p>
                                </div>
                                <div class="col-lg-6 col-sm-6" >
                                    <img src="pictures/pri.jpg" alt="images" style="width:800px;height:440px;margin-top:80px;">
                                </div>

                            </div>
                            <div class="section-full bg-img-fix content-inner overlay-black-middle our-projects-galery"
                    style="background-image:url(images/background/bg9.php); background-position:center;margin-top:20px;">
