                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                <h1 class="bg-info" style="color:white; text-align: center; padding:10px;">Latest News
                                </h1>
...
?>                               <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="admin/process/<?php echo $row['gallery'];?>" target="_blank">
                                                <img src="admin/process/<?php echo $row['gallery'];?>" style="width:50px;height:50px;border-radius:50px;" alt="">
                                            </a>
                                            </td>
