...
<body id="bg">
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(pictures/download.jpg);">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <h1 class="bg-info" style="color:white; text-align: center; padding:10px;">Downloads (
                                    Soft Copy Data )</h1>
