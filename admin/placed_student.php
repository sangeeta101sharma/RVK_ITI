...
if(isset($_GET['id']) && !empty($_GET['id'])){
    $id=$_GET['id'];
    $sql= "SELECT * FROM  placed_student_tbl where id=$id";
    $result= mysqli_query($connection, $sql) or die("Query Failed.");
    if(mysqli_num_rows($result)==0){
         header("location:placed_student.php?status=2&msg=Oops! Record not found..");
    }
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Our Placed Students</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="process/placed_student.php" enctype="multipart/form-data"
                                            method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="photoUpload" class="form-label">Photo Upload(Students )
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="dr_name" class="form-label"> Name</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="specialist" class="form-label">Post</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="weekly" class="form-label">Email</label>
                                                        <input type="email" class="form-control" id="weekly"
                                                            name="weekly"  value="<?php echo (isset($_GET['id']) && !empty($_GET['id'])) ? $row['weekly'] : ""; ?>" required>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="morning" class="form-label">Address</label>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">VIEW PLACED STUDENTS  DETAILS</h4>
                                </div><!-- end card header -->
...
?>
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <td class="customer_name"><a href="../<?php echo $row['image'];?>" target="_blank"><img src="../<?php echo $row['image'];?>" style="width:50px;height:50px;border-radius:50px;" alt=""></a>  </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a class="btn btn-sm btn-success edit-item-btn" href="placed_student.php?id=<?php echo $row['id']?>">Update</a>
                                                                </div> 
                                                                <div class="remove">
                                                                    <a href="process/remove_placed_student.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
