...
if(isset($_GET['id']) && !empty($_GET['id'])){
    $id=$_GET['id'];
    $sql= "SELECT * FROM  students_feedback_tbl where id=$id";
    $result= mysqli_query($connection, $sql) or die("Query Failed.");
    if(mysqli_num_rows($result)==0){
         header("location:student_feedback.php?status=2&msg=Oops.. Record not found!!!");
    }
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">VIEW STUDENTS FEEDBACK DETAILS</h4>
                                </div><!-- end card header -->
                                    ...
                                    <div class="listjs-table" id="customerList">
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <?php 
                                                $i=1;
                                                    $sql= "SELECT * FROM  students_feedback_tbl";
                                                    $result= mysqli_query($connection, $sql) or die("Query Failed.");
                                                     if(mysqli_num_rows($result)>0){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="customer_name"> <?php echo $row['feedback'];?></td>
                                                        <td>
                                                          <!--   <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <a href="process/remove_student_feedback.php?id=<?php echo $row['id'];?>"onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div> 
                                                            </div>
                                                        </td>
                                                    </tr>
