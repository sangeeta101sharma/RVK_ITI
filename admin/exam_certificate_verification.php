...
if($_SERVER["REQUEST_METHOD"]="POST"){
   ...
   /*   if(isset($remark) && !empty($remark)){  
    ...
    $sql = "INSERT INTO `certificate_verification_tbl` (`certificate`)
    VALUES ('$Certificate ')";
...
//   echo $sql= "SELECT * FROM  certificate_verification_tbl where id=$id";  
//   $result= mysqli_query($connection, $sql) or die("Query Failed.");
//    $row = mysqli_fetch_array($result);

//       $sql ="DELETE FROM  certificate_verification_tbl where id=$id";
//      $result=mysqli_query($connection,$sql)or die("Query Failed.");
//     if ($result){
//         $status = 1;
//         $message = " Deleted Successfully...!!";
//         header('location:exam_certificate_verification.php?status='.$status.'&msg='.$message);
//         exit();
//     }else{
//         $status = 2;
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0"> View Exam Certificate Verification Details</h4>
                                </div><!-- end card header -->
                                    ...
                                    <div class="listjs-table" id="customerList">
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <?php
                                                $i=1;
                                                    $sql= "SELECT * FROM   certificate_verification_tbl";
                                                    $result= mysqli_query($connection, $sql) or die("Query Failed.");
                                                ...
                                                <tr><td scope="row">
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <a href="exam_certificate_verification.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
