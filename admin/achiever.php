...
if(isset($_GET['id']) && !empty($_GET['id'])){
    $id=$_GET['id'];
    $sql= "SELECT * FROM  achiever_tbl where id=$id";
    $result= mysqli_query($connection, $sql) or die("Query Failed.");
    if(mysqli_num_rows($result)==0){
         header("location:achiever.php?status=2&msg=Oops! Record not found..");
    }
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Our Achiever</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="process/achiever.php" enctype="multipart/form-data"
                                            method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="photoUpload" class="form-label">Photo Upload(Achiever )
                                                        </label>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">VIEW Our Achiever DETAILS</h4>
                                </div><!-- end card header -->
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <div class="edit">
                                                                    <a class="btn btn-sm btn-success edit-item-btn" href="achiever.php?id=<?php echo $row['id']?>">Update</a>
                                                                </div> 
                                                                <div class="remove">
                                                                    <a href="process/remove_achiever.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
