                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Holiday List </h4>
                                </div><!-- end card header -->
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="process/holiday.php" enctype="multipart/form-data"
                                            method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="holiday_name" class="form-label">Holiday Name
                                                        </label>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">View Holiday List Details </h4>
                                </div><!-- end card header -->
                                <div class="card-body">
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <a href="process/remove_holiday.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
