                            ...
                            <div class="card">
                                ...
                                <?php } ?>
                                    <div class="live-preview">
                                        <form action="process/manage_slider.php" enctype="multipart/form-data" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0"> View Slider Details</h4>
                                </div><!-- end card header -->
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <tr><td scope="row">
                                                        ...
                                                        <td class="customer_name"> <a href="../<?php echo $row['slider'];?>" target="_blank"><img src="../<?php echo $row['slider'];?>" style="width:50px;height:50px;border-radius:50px;" alt=""></a>  </td>
