...
*/
    ...
    if($_POST['action']=="INSERT"){
        $sql = "INSERT INTO `achiever_tbl` (`image`, `doctor`, `specialist`, `contact`, `weekly`, `morning`) VALUES ('$IMAGE', '$doctor', '$specialist', '$contact', '$weekly', '$morning')";
    }else
    if($_POST['action']=="UPDATE"){
        $sql = "UPDATE `achiever_tbl`SET `image`='$IMAGE', 
        `doctor`='$doctor',
